					...
					<form:form action="Register" commandName="Register" method="POST" onsubmit="return validate">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<form:input type="password" class="form-control" name="pwd" id="pwd"  placeholder=" Password" path="pwd"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<input type="password" class="form-control" name="cpwd" id="cpwd"  placeholder=" Confirm Password" path="pwd"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="address" id="address"  placeholder=" Enter Address" path="address"/>
								</div>
							</div>
						</div>
